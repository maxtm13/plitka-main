...
$arResult["SECTIONS"] = [];
if($arParams["BRAND"]){
	$arFilter = ['IBLOCK_ID' => $arParams["IBLOCK_ID"],'ID' => $arParams["BRAND"]["SECTIONS"], "ACTIVE"=>"Y", "DEPTH_LEVEL" => "1"];
   $rsSect = CIBlockSection::GetList([],$arFilter, false, ["PICTURE", "NAME", "CODE", "ACTIVE", "DEPTH_LEVEL"]);
