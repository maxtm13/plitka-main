...
<div class="bx_content_section">
		...
		<? foreach($arResult["SECTIONS"] as $sect): ?>
				...
				<li class="lvl1">
					...
					<a href="/<?=$arParams["TYPE"];?>/<?=$sect["CODE"];?>/<?=$arParams["BRAND"]["CODE"];?>" class="bx_catalog_tile_img" title="<?=$sect["NAME"];?>"><img src="<?=$sect["PICTURE"];?>" alt="<?=$sect["NAME"];?>" title="<?=$sect["NAME"];?>" class="catalog_item_img"></a>
					<a class="bx_catalog_tile_title" href="/<?=$arParams["TYPE"];?>/<?=$sect["CODE"];?>/<?=$arParams["BRAND"]["CODE"];?>"><?=$arParams["BRAND"]["NAME"];?> <?=$sect["NAME"];?></a>
				</li>
				<? endif; ?>
		<?	endforeach; ?>
			</ul>
