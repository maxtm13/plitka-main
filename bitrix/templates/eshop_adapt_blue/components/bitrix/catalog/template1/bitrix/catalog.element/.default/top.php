...
$checkdate = date('Y',strtotime(date().'-01-01 -1year'));
    ...
    <div class="new-row-even">
        <? //Постоянная старая цена
		    if (($arResult['PROPERTIES']['OLD_PRICE']['VALUE']) > ($arResult['MIN_PRICE']['VALUE']) && empty($arResult['PROPERTIES']['DISCOUNT_PERCENT']['VALUE'])) { ?>
            	<div class="tim_old_pice"><? echo $arResult['PROPERTIES']['OLD_PRICE']['VALUE'];?><? echo GetMessage('OLD_PRICE_MESS_CUR');?></div>  
        <? };?>	
        ...
        <div class="item_price" itemprop="offers" itemscope itemtype="http://schema.org/Offer" style="<?=$full;?>">
			...
			<? \Bitrix\Main\Page\Frame::getInstance()->finishDynamicWithID("price5"); ?>
                ...
                <? echo ($boolDiscountShow ? '<div style="display: inline-block;padding: 0 0 0 10px;">' : ''); ?>
                    <?/*---bgn 2019-08-09---*/?>
                    <span class="item_economy_price" id="<? echo $arItemIDs['DISCOUNT_PRICE']; ?>" style="display: <? echo ($boolDiscountShow ? '' : 'none'); ?>">
        ...
        ?>
            ...
            <div class="item_buttons vam">
                ...
                <span class="item_buttons_counter_block">
                    <a href="javascript:void(0);" class="<? echo $buyBtnClass; ?>" id="<? echo $arItemIDs['BUY_LINK']; ?>"><?=$buyBtnMessage?></a>
        <?
        ...
        ?>
                ...
                <?php if ($units_recalc) {
                    ...
                    <div style="<?=$align;?>" class="calc-measures" data-inpt="<? echo $arItemIDs['QUANTITY']; ?>" data-w="<?php echo $itemSize[0]; ?>" data-h="<?php echo $itemSize[1]; ?>" data-sqr="<?php echo round($sqr * 10000) / 10000; ?>" data-pac="<?php echo $dataPac; ?>">
...
доставка">
                        <a href="/content/dostavka-plitki-i-keramogranita-po-moskve-i-rossii/#free_shipping" target="_blank"><span style="border-bottom: 2px dotted; color: #3e77aa;">Бесплатная<br>доставка</span></a>
                    </div>
                    <div class="new-icon">
...
скидки">
                  ...
                  <? elseif($arResult['PROPERTIES']['DISCOUNT']['VALUE'] == 2):?>
		 					<a href="/promotions/aktsiya-na-proizvoditeley-delacora-altacera-kerama-marazzi-uralkeramika-alma-ceramica-italon-laparet/"><img src="/image/banner_2.jpg" style="
    display: block;
    max-width: 100%;
    margin: 20px 0;
    height: auto;
    ...
    width: 93%;
                 ...
                 <? elseif($arResult['PROPERTIES']['DISCOUNT']['VALUE'] == 4):?>
		 					<a href="/promotions/aktsiya-na-proizvoditeley-delacora-new-trend-coliseum-gres-altacera-uralkeramika-alma-ceramica-lapar/"><img src="/image/akzii_v4.jpg" style="
    display: block;
    max-width: 100%;
    margin: 20px 0;
    height: auto;
    ...
    ?>
        ...
        <?echo "<div style='padding: 10px 0px; float: left;'>Код товара: {$arResult['ID']}</div>";?>
...
//var_dump($USER->IsAuthorized());
            if ($USER->IsAuthorized()){?>
                <?if(!$isDelayed){?>
                    <span class="favorite-icon wishbtn " style="float:left; padding-top: 9px; margin-left: 15px;"
                    onclick="add2wish('<?=$arResult["ID"]?>','<?=$arResult["CATALOG_PRICE_ID_1"]?>','<?=$arResult["CATALOG_PRICE_1"]?>','<?=$arResult["NAME"]?>','<?=$arResult["DETAIL_PAGE_URL"]?>',this)">
                        <img style="float:left" src="<?=SITE_TEMPLATE_PATH?>/images/favorite.png" alt="Favorite-Whishlist" style="max-width:32px;"/>
                        <div class="count" style="float:left"><?=$delaydBasketItems?></div>
                    </span>
                <?}else{?>
                    <span class="favorite-icon wishbtn in_wishlist" style="float:left; padding-top: 9px; margin-left: 15px;">
                        <img style="float:left" src="<?=SITE_TEMPLATE_PATH?>/images/favorite_full.png" alt="Whishlist" style="max-width:32px;"/>
                        <div class="count" style="float:left"><?=$delaydBasketItems?></div>
                    </span>
                <?}
            }
    ...
    <div class="new-row-even" style="border: 1px solid #e7e7e7;position: relative;">
        ...
        <a href="/promotions/nashli-deshevle-my-snizim-tsenu/" target="_blank" rel="nofollow"><span style="color: rgb(54,183,40);font-weight: bold;font-size: 18px;line-height: 18px;"></span><br></a>
        <span class="predl" style="color: rgb(75,75,75);font-size: 16px"></span>
...
<div class="bx_md" >
    <div class="prim">
        <div><a href="/content/dostavka-plitki-i-keramogranita-po-moskve-i-rossii/" target="_blank"><img src="/upload/prim/9.png" alt="Быстрая Доставка по всей России!"><span style="text-decoration: Dotted underline;">Быстрая Доставка<br> по всей России!</span></a></div>
