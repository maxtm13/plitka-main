...
if($arResult["VARIABLES"]["SECTION_CODE"] && $arResult["VARIABLES"]["ELEMENT_CODE"]){
	$isID = '';
	$res = CIBlockElement::GetList([], ["IBLOCK_ID"=>$arParams["IBLOCK_ID"], "SECTION_CODE"=>$arResult["VARIABLES"]["SECTION_CODE"],"CODE"=>$arResult["VARIABLES"]["ELEMENT_CODE"], "ACTIVE"=>"Y"], false, [], ["ID","IBLOCK_SECTION_ID","DETAIL_PAGE_URL"])->GetNext();
	$isID = $res["ID"];
...
<div class="tabs-wrapper">
    <div class="tabs-switch simpleText title-bg uppercase">
        <a href="#tabViewed" class="active"><?=GetMessage('TAB_VIEWED_TITLE')?></a>
        <a href="#tabRecommendations"><?=GetMessage('TAB_RECOMMENDATIONS_TITLE')?></a>
    </div>
    <div class="tabs noTitle">
        <div class="tab" id="tabViewed">
            <?/*---вы смотрели---*/?>
            <div class="viewedProdWrapper"></div>
        </div>
