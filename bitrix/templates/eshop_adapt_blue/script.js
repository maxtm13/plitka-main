...
(function ($) {
	...
	$(function () {
		...
		$(document).click(function (e) {
			var $currItem = $(e.target).closest(".pnd__return");
			if ($currItem.length) {
				$currItem.closest("li.js-open").removeClass("js-open");
			}
		});
		$(document).click(function (e) {
			var $currItem = $(e.target).closest(".rbs-filter-btn");
			if ($currItem.length) {
				$(".pnd-vm-top-2018").removeClass("js-open");
				$(".rbs-call-phones").removeClass("show");
		...
		$(document).click(function (e) {
			var $currItem = $(e.target).closest(".rbs-catalog-btn");
			if ($currItem.length) {
				$(".sidebar").removeClass("show");
				$(".rbs-call-phones").removeClass("show");
				if($(".pnd-vm-top-2018").hasClass("js-open")){
					$(".pnd-vm-top-2018").removeClass("js-open");
				}else{
					$(".pnd-vm-top-2018").addClass("js-open");
				}
			}
		});

		$(document).click(function (e) {
			var $currItem = $(e.target).closest(".rbs-call-answer a");
			if ($currItem.length) {
				$(".sidebar").removeClass("show");
				$(".pnd-vm-top-2018").removeClass("js-open");
				if($(".rbs-call-phones").hasClass("show")){
					$(".rbs-call-phones").removeClass("show");
				}else{
					$(".rbs-call-phones").addClass("show");
				}
			}
		});
