						...
						<div class="bx_catalog_item_controls">
							...
							if ($arItem['CAN_BUY'] && !in_array($arItem['DISPLAY_PROPERTIES']['AVAILABILITY']['VALUE_ENUM_ID'], array(4914, 5044, 5649)))
							{
								...
								?>
									...
									if ($arItem['CATALOG_MEASURE_NAME'] == 'кв. м.' && !empty($arItem['DISPLAY_PROPERTIES']['SIZE_WIDTH']['VALUE']) && !empty($arItem['DISPLAY_PROPERTIES']['SIZE_LENGTH']['VALUE']) && $arParams['IBLOCK_ID'] == CATALOG_ID) {
										$itemSize =array(
