...
if ((($hour >= 20 && $minutes >= 45) || ($hour <= 8 && $minutes < 30)) && in_array($arParams['IBLOCK_ID'], array(CATALOG_ID, CATALOG_FLOOR_ID, CATALOG_SANTEH_ID))) {
	if (!empty($arResult['DISPLAY_PROPERTIES']['NIGHT_PRICE']['DISPLAY_VALUE']) == 1) {
...
<?
$arE = CIblockElement::GetById($arResult["ID"])->GetNext();
if($_SERVER['REQUEST_URI']!=$arE['DETAIL_PAGE_URL']){
$APPLICATION->AddHeadString('<link rel="canonical" href="https://www.plitkanadom.ru'.$arE['DETAIL_PAGE_URL'].'" />');
}
?>