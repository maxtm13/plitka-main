...
/*	jQuery(".parent.manufacturer > a").click(function(){
    ...
    /*if (getCookie("RememberedUser") != "Yes") { // показываем меню для нового посетителя
      jQuery("ul.pnd-vm-top > li:first").addClass("jsvhover");
      setCookie("RememberedUser", "Yes");
      $("HTML").on("click", function(){jQuery("ul.pnd-vm-top > li:first").removeClass("jsvhover"); $(this).unbind("click")});  // по любому клику скрываем меню    
    }*/
	});
	...
	//подменяем мобильного меню каталога
	jQuery.ajax({
