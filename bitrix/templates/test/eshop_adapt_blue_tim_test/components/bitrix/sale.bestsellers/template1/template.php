...
<div class="bx_item_list_bestsellers col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>">
	<div class="cube-1"><img src="/bitrix/templates/eshop_adapt_blue/images/bg-top.png" alt="bg-top" /></div>
	<div class="top_sale">
		<span class="block-title"><? echo GetMessage('SB_HREF_TITLE') ?>:</span>
	</div>
	<div class="top_sale-link">
		<a href="/hits/">Все хиты</a>
	</div>
