	...
	function CustomizeLHEForBlogComments()
	{
		...
		window.LHEDailogs['BlogVideo'] = function(pObj)
		{
			var str = '<table width="100%"><tr>' +
				'<td class="lhe-dialog-label lhe-label-imp"><label for="' + pObj.pLEditor.id + 'lhed_blog_video_path"><span style="font-weight:bold;"><?= GetMessageJS('BPC_VIDEO_P')?>:</span></label></td>' +
				'<td class="lhe-dialog-param">' +
