...
if ($arResult['SECTION']['DEPTH_LEVEL'] > 0) {
	...
	<div class="sec-sort">
		...
		<span class="sort-param<?php if (isset($_REQUEST['s']) && in_array($_REQUEST['s'], array('poa', 'pod'))) { echo ' active'; } ?>">
			...
			<a class="ico-sort-abc-asc<?php if (isset($_REQUEST['s']) && $_REQUEST['s'] == 'poa') { echo ' active'; } ?>" href="<?php echo $APPLICATION->GetCurPageParam('s=poa', array('s')); ?>" title="<?php echo GetMessage('SORT_ASC'); ?>"></a>
			<a class="ico-sort-abc-desc<?php if (isset($_REQUEST['s']) && $_REQUEST['s'] == 'pod') { echo ' active'; } ?>" href="<?php echo $APPLICATION->GetCurPageParam('s=pod', array('s')); ?>" title="<?php echo GetMessage('SORT_DESC'); ?>"></a>
		</span>
	</div>
<?php }
$w = 240; $h = 480;
