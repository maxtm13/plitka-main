				...
				<div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
					...
					?>
						...
						?>
							...
							{
								if (/*$pid == 'AVAILABILITY' || $pid == 'RECOMMENDED_PRICE'*/ in_array($pid, array('AVAILABILITY', 'RECOMMENDED_PRICE', 'NIGHT_PRICE', 'MARGIN'))) continue;
						...
						?>
							<div class="bx_catalog_item_articul">
								...
								if ($boolShowProductProps)
								{
									foreach ($arItem['DISPLAY_PROPERTIES'] as $pid => $arOneProp)
									{
										if (/*$pid == 'AVAILABILITY'*/ in_array($pid, array('AVAILABILITY', 'NIGHT_PRICE', 'MARGIN'))) continue;
									?><br><div class="bx_catalog_item_articul_23"><? echo $arOneProp['NAME']; ?>:</div> <?
										echo (
											is_array($arOneProp['DISPLAY_VALUE'])
