...
<?endif?>
<div class="rodobwna" <?if ($arResult["allSum"] >= 10000):?>style="display:none;"<?endif?>>
<p class="min-order">Оформление заказа возможно после наполнения корзины на сумму более 10 000 рублей.</p>	
...
<p><b style="color: #333333; font-family: arial;">Минимальная сумма заказа в нашем интернет-магазине составляет 10.000 рублей</b></p>
...
Стоимость доставки плитки внутри 3-го транспортного кольца составляет 1500 руб.
За пределами МКАД доставка плитки стоит 35 руб за 1 км расстояния от МКАД плюс 1500 руб
</p>
<p>
