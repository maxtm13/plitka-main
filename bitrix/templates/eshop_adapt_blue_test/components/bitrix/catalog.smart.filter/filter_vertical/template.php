...
<style>
.bx_filter_vertical .bx_filter_block {display: block;padding-bottom: 40px; position: relative; overflow: hidden; -webkit-transition: .5s; -o-transition: .5s; transition: .5s; }
.bx_filter_vertical .bx_filter_block.w-toggle .js-heighter-toggle {display: block;}
.js-heighter-toggle {position: absolute; bottom: 0; left: 0; right: 0; line-height: 40px; height: 40px; text-decoration: underline; cursor: pointer; z-index: 2; display: none;} 
.js-heighter-toggle:after {content: 'Показать все';} .js-heighter-toggle._opened:after {content: 'Скрыть'; } 
.js-heighter-toggle:before {content: ''; z-index: -1; position: absolute; bottom: 0; top: 0; left: 0; right: 0; display: block; background-color: #fff; } 
.js-heighter-toggle:hover {text-decoration: none; }
.bx_filter_container { overflow: hidden; opacity: 0;}
.bx_filter_container.init {opacity: 1; -webkit-transition: .5s; -o-transition: .5s; transition: .5s;}
</style>
